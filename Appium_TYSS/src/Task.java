...
public class Task 
{
	...
	v.sendKeys("NTSS7821");
		...
		driver.findElement(By.id("com.healthifyme.basic:id/fab_add_activity")).click();
		driver.findElement(By.id("com.healthifyme.basic:id/et_track_workout")).click();
		driver.findElement(By.id("com.healthifyme.basic:id/et_search")).sendKeys("walking");
		try{
			driver.hideKeyboard();
		}
		catch(Exception e)
		...
		driver.findElement(By.id("com.healthifyme.basic:id/fab")).click();
		driver.findElement(By.id("com.healthifyme.basic:id/iv_overflow_menu_card")).click();
		driver.findElement(By.id("com.healthifyme.basic:id/title")).click();
